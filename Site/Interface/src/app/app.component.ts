...
export class AppComponent {
  ...
  window.location.href = "fusion360://command=insert&file=" + encodeURIComponent("C:/Users/8916m/Desktop/Bearing GOST 8328-75_2000.f3d") +
      "&properties=" + encodeURIComponent(JSON.stringify(properties)) + 
      "&privateInfo=" + encodeURIComponent("gege") +
